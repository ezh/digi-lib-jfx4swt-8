...
class Window(owner: JFXWindow, screen: Screen, mask: Int) extends JFXWindow(owner, screen, JFXWindow.UNTITLED) {
  ...
  protected def _releaseInput(a1: Long) {}
  protected def _requestFocus(pointer: Long, event: Int): Boolean = true
  protected def _requestInput(a1: Long, a2: String, a3: Int, a4: Double, a5: Double, a6: Double, a7: Double, a8: Double, a9: Double, a10: Double, a11: Double, a12: Double, a13: Double, a14: Double, a15: Double, a16: Double, a17: Double) {}
  ...
  protected def _setIcon(pointer: Long, pixels: JFXPixels) {}
